...
AppliesToCollections.propTypes = {
  onClickAdd: PropTypes.func.isRequired,
  onClickRemove: PropTypes.func.isRequired,
  value: PropTypes.arrayOf(collectionShape).isRequired,
  defaultValue: PropTypes.arrayOf(collectionShape).isRequired,
  i18n: PropTypes.shape({ translate: PropTypes.func.isRequired }).isRequired,
  appliesTo: PropTypes.oneOf(["all", "collections"]).isRequired,
